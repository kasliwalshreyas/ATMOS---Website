...
class projectController {
    ...
    post_add_project = async (req,res) => {
    ...
    post_delete_project = async (req,res) =>  {
    ...
    get_add_favorite_project = async (req,res) =>  {
    ...
    get_redirected_to_project = (req,res) => {
        res.redirect('/projects');
    }
}
