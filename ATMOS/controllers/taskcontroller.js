...
class taskController {
    ...
    post_updated_section_name = async (req,res) => {
    ...
    post_delete_task = async (req,res) => {
    ...
    get_delete_section = async (req,res) => {
